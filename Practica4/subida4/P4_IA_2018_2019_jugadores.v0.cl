	...
	(loop for columna from 0 below (tablero-ancho tablero) do
		(loop for fila from 0 below (tablero-alto tablero)do
	      (let* ((altura (altura-columna tablero columna))
			...
			;si es null
				(cond ((and (= fila 0) (= columna 3)) (setf puntuacion-actual (+ puntuacion-actual 5000)))
					  ((and (= fila 0) (= columna 2)) (setf puntuacion-actual (+ puntuacion-actual 2500)))
					  ((and (= fila 0) (= columna 4)) (setf puntuacion-actual (+ puntuacion-actual 2500)))
					  (T (setf puntuacion-actual (+ puntuacion-actual 0))))
			;si no lo es
			(setf puntuacion-oponente
		      (+ puntuacion-oponente
			 (cond ((= abajo 0) 0)
